...
\begin{itemize}
\item Three sessions
\item In class: mostly theory, no code, no math % some code, not much maths
...
\item \fbox{Variable types}
  ...
  \end{itemize}
\item \fbox{Population statistics ($\times 5$)}
  \begin{itemize}
  \item sample mean vs population \fbox{mean ($\times 5$)}
...
% \vspace{10mm}
% \centerline{\Large J-0x01 - Practicum}
% \vspace{5mm}
